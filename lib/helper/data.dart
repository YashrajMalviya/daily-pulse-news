import 'package:daily_pulse_news/models/category_model.dart';
List<CategoryModel> getCategories(){
  List<CategoryModel> category = [];
  CategoryModel categoryModel = CategoryModel();

  categoryModel.categoryName = "Business";
  categoryModel.imageUrl = "https://media.istockphoto.com/id/1463681745/photo/businessman-use-electronic-pen-writing-rising-colorful-graph-from-2023-to-2024-year-of.jpg?s=1024x1024&w=is&k=20&c=jXzSmKowNJBuHD6jF6ckbpnHQfnbRXLuIX2b3vyD3rY=";
